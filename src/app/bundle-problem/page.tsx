...
const JobAnalytics = dynamic(() => import("@/components/job-analytics").then(m => m.JobAnalytics), {
  ssr: false,
  loading: () => (
    <div className="bg-gray-800 rounded-xl p-6 animate-pulse">
      <div className="h-8 bg-gray-700 rounded w-64 mb-6" />
      <div className="grid grid-cols-4 gap-4 mb-8">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="bg-gray-700 rounded-lg h-20" />
        ))}
      </div>
